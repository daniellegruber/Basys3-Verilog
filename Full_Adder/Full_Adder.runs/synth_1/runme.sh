...
HD_PWD='C:/Users/danie/OneDrive/Documents/Vivado/Basys3/Full_Adder/Full_Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_Full.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder_Full.tcl
