...
HD_PWD='C:/Users/danie/OneDrive/Documents/Vivado/Basys3/Full_Adder/Full_Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_Full.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder_Full.tcl -notrace
