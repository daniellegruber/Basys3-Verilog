...
HD_PWD='C:/Users/danie/OneDrive/Documents/Vivado/Basys3/Adder_4bit/Adder_4bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder_4bit.tcl -notrace
