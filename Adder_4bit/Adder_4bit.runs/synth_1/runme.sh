...
HD_PWD='C:/Users/danie/OneDrive/Documents/Vivado/Basys3/Adder_4bit/Adder_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder_4bit.tcl
