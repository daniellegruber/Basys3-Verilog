...
HD_PWD='C:/Users/danie/OneDrive/Documents/Basys3-Verilog/midterm_neuron/midterm_neuron.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Midterm_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Midterm_Top.tcl
