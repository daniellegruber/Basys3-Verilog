...
HD_PWD='C:/Users/danie/OneDrive/Documents/Basys3-Verilog/midterm_neuron/midterm_neuron.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Midterm_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Midterm_Top.tcl -notrace
