...
HD_PWD='C:/Users/danie/OneDrive/Documents/Basys3-Verilog/test/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LEDglow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LEDglow.tcl
