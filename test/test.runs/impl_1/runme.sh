...
HD_PWD='C:/Users/danie/OneDrive/Documents/Basys3-Verilog/test/test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LEDglow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LEDglow.tcl -notrace
